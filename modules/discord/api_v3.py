...
from modules.models.api_v3 import *
...
@router.websocket("/api/v/3/ws") # Compatibility, will be undocumented soon
@router.websocket("/api/v/3/ws/bot")
...
@router.websocket("/api/ws/v/3/chat")

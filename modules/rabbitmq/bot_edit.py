...
async def backend(state, json, *, user_id, bot_id, prefix, library, website, banner_card, banner_page, support, long_description, description, tags, extra_owners, invite, webhook, vanity, github, features, long_description_type, webhook_type, webhook_secret, css, donate, privacy_policy, nsfw, keep_banner_decor, **kwargs):
    await state.postgres.execute("UPDATE bots SET bot_library=$2, webhook=$3, description=$4, long_description=$5, prefix=$6, website=$7, discord=$8, banner_card=$9, invite=$10, github = $11, features = $12, long_description_type = $13, webhook_type = $14, css = $15, donate = $16, privacy_policy = $17, nsfw = $18, webhook_secret = $19, banner_page = $20, keep_banner_decor = $21 WHERE bot_id = $1", bot_id, library, webhook, description, long_description, prefix, website, support, banner_card, invite, github, features, long_description_type, webhook_type, css, donate, privacy_policy, nsfw, webhook_secret, banner_page, keep_banner_decor) # Update bot with new info

...
function testHook(a,b){headers={Authorization:context.bot_token};$j.ajax({url:"/api/bots/"+context.bot_id+"/testhook",dataType:"json",headers:headers,type:"POST",processData:!1,contentType:"application/json",statusCode:{200:function(c){modalShow("Sent test query","See the below tip if you didn't get it!")}}})};
